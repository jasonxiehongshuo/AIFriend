...
import MenueIcon from "@/components/navbar/icons/MenueIcon.vue";
...
<template>
  <div class="drawer lg:drawer-open">
      ...
      <nav class="navbar w-full bg-base-300 shadow-sm">
        ...
        <div class="navbar-center w-4/5 max-w-180 flex justify-center">
          <div class="join w-4/5 flex justify-center">
              ...
              <button class="btn join-item rounded-r-full gap-0"><search-icon />搜索</button>
            </div>
        </div>
        <div class="navbar-end">
          ...
          <RouterLink v-if="user.hasPulledUserInfo && !user.isLogin()" :to="{name:'user-account-login-index'}" active-class="btn-focus" class="btn btn-ghost text-lg">
            登录
          </RouterLink>
    ...
    <div class="drawer-side is-drawer-close:overflow-visible">
      ...
      <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-16 is-drawer-open:w-34">
